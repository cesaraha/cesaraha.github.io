export const translations = {
  fr: {
    titlePage: "César Aha",
    redirection: {
      name: "César Hernandez Álvarez",
      title: "Cherchez-vous le portfolio?",
      paragraph1: "Ce site a été déplacé, veuillez suivre le lien ci-desous pour le visiter:",
      paragraph2: "Portfolio - César Hernandez Alvarez",
    },
    navigation: {
      home: "Accueil",
      about: "À propos",
    ...
    about: {
      ...
      paragraph1:
        "Je suis docteur en Ingénierie Médicale, avec une expérience dans les projets de R&D liés à l'imagerie optique, au traitement d'images et au Deep Learning. Également, je fais du développement Web.",
      paragraph2:
        "Dans ma recherche, je m'intéresse particulièrement aux solutions d'IA appliquées à l'imagerie (bonus si c'est médical), en combinant des pratiques de code propre et d'optimisation. En tant que développeur web, j'aime créer et concevoir des applications et sites web avec un design centré sur l'utilisateur pour offrir des expériences numériques exceptionnelles, toujours adaptées aux besoins du client.",
      studiesTitle: "Formations",
      studies1: {
        heading: "Licence en Ingénierie Médicale",
        placeAndDate: "Sinaloa, Mexique | Sep 2014 - Jan 2018",
        details:
          "Axée sur le développement de prototypes en utilisant des compétences en électronique, mécanique et programmation.",
      },
      studies2: {
        heading: "Doctorat en Ingénierie Médicale et Diplôme en R&D",
        placeAndDate: "Londres, Royaume-Uni | Oct 2019 - Avr 2025",
        details:
          "Développement de systèmes d'imagerie optique en utilisant des méthodes de reconstruction conventionnelles, des algorithmes d'optimisation et du Deep Learning.",
      },
      ...
      experience1: {
        ...
        details:
          "Imagerie optique, Deep Learning pour la reconstruction d'images avec Python, Tensorflow et Keras.",
      },
      experience2: {
        heading: "Chargé de travaux pratiques",
        placeAndDate: "Queen Mary University of London | Sep 2021 - Août 2023",
        details:
          "Enseignement et tutorat en Mathématiques, Physique, Électronique et programmation Python pour les étudiants de premier cycle.",
      },
      experience3: {
        heading: "Ingénieur R&D",
        placeAndDate: "Tecnológico de Monterrey | Août 2017 - Jan 2018",
        details:
          "Développement d'un système de suivi oculaire en utilisant C# et VS Code.",
      },
    },
    skills: {
      title: "Compétences",
      ...
      nameSection4:
        "Développement d'applications et web (Frameworks et autres outils)",
    },
    projects: {
      title: "Projets",
      project1: {
        ...
        details:
          "Modèles de Deep Learning pour la reconstruction d'objets derrière des milieux diffusants (thèse de doctorat)",
        description:
          "Turbides (ou diffusants) désignent les matériaux qui ne laissent pas passer la lumière, " +
      ...
      project2: {
        heading: "Site portfolio développé avec React",
        details:
          "Site personnel créé avec React dans VS Code, déployé via GitHub et hébergé sur Netlify",
        description:
          "Ce portfolio et mon site freelance, <a href='https://cesaraha.fr'>cesaraha.fr</a>, " +
          "sont deux projets connectés mais distincts.<br/><br/>cesaraha.fr est le moyen le plus simple " +
          "de me contacter pour des collaborations freelance. Il a été développé avec <strong>React</strong>, " +
          "l'un des frameworks JavaScript les plus utilisés, en tirant parti de la réutilisabilité " +
          "de ses composants et de sa configuration simple. Le site est déployé en continu sur " +
          "<strong>Netlify</strong>, et se met automatiquement à jour après chaque push " +
          "<strong>Git</strong>.<br/><br/>Ce portfolio a été développé également avec " +
          "<strong>React</strong>. J'ai décidé de séparer le portfolio du site freelance " +
          "afin de présenter mes projets plus clairement, tout en gardant le contenu professionnel " +
          "sur une page dédiée.<br/><br/>Ce portfolio est hébergé sur <strong>GitHub Pages</strong>, " +
          "avec <strong>GitHub Actions</strong> assurant les déploiements automatisés après chaque " +
          "push. Vous pouvez retrouver les deux dépôts sur mon <a href='https://github.com/cesaraha'>profil GitHub</a>.",
      },
      project3: {
        heading: "Generateur IA d'exercices mathematiques",
        details:
          "Plateforme de génération de contenu mathématique, avec suivi des performances et exercices adaptatifs.",
        description:
          "Ce projet est un <strong>générateur d'opérations mathématiques</strong>. Dans un premier temps, " +
      ...
      project4: {
        ...
        details:
          "Algorithmes de reconnaissance optique de caractères pour images et documents numérisés",
        description:
          "Développement d'un algorithme capable de reconnaître les mots dans les documents scannés et les fichiers d'images pour une localisation et classification faciles.",
      },
      project5: {
        heading: "Segmentation cellulaire dans des images de microscopie",
        details:
          "Algorithmes de traitement d'image pour la segmentation cellulaire dans des images de microscopie",
        description:
          "Développement d'algorithmes de traitement d'images pour la segmentation des cellules dans les images de microscopie à des fins de comptage et de classification.",
      },
      project6: {
        heading: "Détection et suivi d'objets avec OpenCV",
        details:
          "Détection et suivi d'objets dans des vidéos à l'aide d'OpenCV et de Python",
        description:
          "Développement d'applications pour la détection et le suivi d'objets en utilisant OpenCV et Python. Entraîné avec les modèles YOLOv5 et YOLOv8.",
      },
      project7: {
        heading: "Segmentation d'images médicales",
        details: "Visualisation, exploration et segmentation de coupes d'IRM",
        description:
          "Développement d'applications pour l'affichage, l'exploration et la segmentation de coupes IRM dans quatre modalités différentes.",
      },
    },
    ...
    contact: {
      title: "Contactez-moi!",
      description:
        "Je serais ravi d'avoir de vos nouvelles ! Que vous ayez une question, que vous souhaitiez discuter d'un projet ou simplement dire bonjour, n'hésitez pas à me contacter.",
      tags: {
        name: "Nom complet",
        email: "Email",
        phone: "Téléphone",
  ...
  en: {
    ...
    redirection: {
      name: "César Hernandez Álvarez",
      title: "Are you looking for the portfolio?",
      paragraph1: "This page was moved, please follow this link to visit the new one:",
      paragraph2: "Portfolio - César Hernandez Alvarez",
    },
    navigation: {
      home: "Home",
    ...
    about: {
      ...
      paragraph1:
        "I am a doctor in Medical Engineering, with experience in R&D projects related to optical imaging, image processing and Deep Learning. I also do web development.",
      paragraph2:
      ...
      studies1: {
        ...
        details:
          "Focused in the development of prototyping by using electronics, mechanics and programming skills.",
      },
      studies2: {
        heading: "PhD in Medical Engineering and Diploma in R&D",
        placeAndDate: "London, United Kingdom | Oct 2019 - Apr 2025",
        details:
          "Development of optical imaging systems by using conventional reconstruction methods, optimisation algorithms and Deep Learning.",
      },
      ...
      experience1: {
        ...
        details:
          "Optical imaging, Deep Learning for the reconstruction of images with Python, Tensorflow and Keras.",
      },
      experience2: {
        heading: "Laboratory Demonstrator",
        placeAndDate: "Queen Mary University of London | Sep 2021 - Aug 2023",
        details:
          "Teaching and tutoring for Math, Physics, Electronics and Python programming to undergraduate students.",
      },
      experience3: {
        heading: "R&D Engineer",
        placeAndDate: "Tecnológico de Monterrey | Aug 2017 - Jan 2018",
        details:
          "Development of an eyetracking system by using C# and VS Code.",
      },
    },
    skills: {
      title: "Skills",
    ...
    projects: {
      ...
      project1: {
        ...
        details:
          "Deep Learning models for the reconstruction of objects behind scattering media (PhD thesis)",
        description:
          "Turbid (or scattering) media refers to materials that do not allow light to pass through, " +
      ...
      project2: {
        ...
        details:
          "Personal website built using Svelte in VS Code, deployed by GitHub and hosted by Netlify",
        description:
          "This portfolio and my freelance website, <a href='https://cesaraha.fr'>cesaraha.fr</a>, " +
          "are two connected but distinct projects.<br/><br/>cesaraha.fr is the easiest way to reach me for " +
          "freelance collaborations. It was built with <strong>React</strong>, one of the most widely used " +
          "JavaScript frameworks, leveraging its reusable components and simple configuration. The site is " +
          "continuously deployed to <strong>Netlify</strong>, updating automatically after every " +
          "<strong>Git</strong> push.<br/><br/>This portfolio was developed with <strong>React</strong> as " +
          "well. I decided to separate the portfolio from the freelance site to present my projects clearly " +
          "while keeping business-related content on a dedicated page.<br/><br/>This portfolio is hosted on " +
          "<strong>GitHub Pages</strong> with <strong>GitHub Actions</strong> handling automated deployments " +
          "on every push. You can find both repositories on my <a href='https://github.com/cesaraha'>GitHub " +
          "profile</a>.",
      },
      project3: {
        heading: "AI math generator",
        details:
          "Platform for practicing mathematical operations with performance tracker and adaptive exercises",
        description:
          "This project is a <strong>mathematical operations generator</strong>. At first, it produces " +
      ...
      project4: {
        ...
        details:
          "Optical Character Recognition algorithms for images and scanned documents",
        description:
          "Development of an algorithm capable of recognizing words in scanned documents and image files for easy location and classification.",
      },
      project5: {
        heading: "Cell segmentation in microscopy images",
        details:
          "Image processing algorithms for cell segmentation in microscopy images",
        description:
          "Development of image processing algorithms for the segmentation of cells in microscopy images for counting and classification purposes.",
      },
      project6: {
        heading: "Object detection and tracking with OpenCV",
        details:
          "Detection and tracking of objects in video data by using OpenCV and Python",
        description:
          "Development of applications for the detection and tracking of objects using OpenCV and Python. Trained with YOLOv5 and YOLOv8 models.",
      },
      project7: {
        heading: "Medical imaging segmentation",
        details: "Visualization, exploration and segmentation of MRI slices",
        description:
          "Development of applications for the display, exploration and segmentation of MRI slices in four different modalities.",
      },
    },
    readMore: "Read more",
  ...
  sp: {
    ...
    redirection: {
      name: "César Hernandez Álvarez",
      title: "¿Estás buscando el portafolio de proyectos?",
      paragraph1: "La página fue movida. Puedes consultarla en el siguiente enlace:",
      paragraph2: "Portafolio - César Hernandez Alvarez",
    },
    navigation: {
      home: "Inicio",
      about: "Acerca de",
    ...
    about: {
      ...
      paragraph1:
        "Soy doctor en Ingeniería Biomédica, con experiencia en proyectos R&D ligados a la imagenología óptica, al procesamiento de imágenes y al aprentizaje profundo (Deep Learning). También me dedico al desarrollo web.",
      paragraph2:
        "En investigación, estoy particularmente interesado en soluciones de IA aplicadas a la imagenología (puntos extra si es médica), combinando buenas prácticas de codage y optimización. Como desarrollador web, me encanta crear y diseñar aplicaciones y sitios web con un diseñocentrado en el usuario para ofrecer experiencias tecnológicas excepcionales, siempre adaptadas a las necesidades del cliente.",
      studiesTitle: "Educación",
      studies1: {
        heading: "Licenciatura en Ingeniería Biomédica",
        placeAndDate: "Sinaloa, México | Sep 2014 - Ene 2018",
        details:
          "Enfocada en el desarrollo de prototipos utilizando habilidades de electrónica, mecánica y programación.",
      },
      studies2: {
        heading: "Doctorado en Ingeniería Médica y Diploma en I+D",
        placeAndDate: "Londres, Reino Unido | Oct 2019 - Abr 2025",
        details:
          "Desarrollo de sistemas de imagenología óptica utilizando métodos de reconstrucción convencionales, algoritmos de optimización y Deep Learning.",
      },
      ...
      experience1: {
        ...
        details:
          "Imagenología óptica, Deep Learning para la reconstrucción de imágenes con Python, Tensorflow y Keras.",
      },
      experience2: {
        heading: "Demostrador de Laboratorio",
        placeAndDate: "Queen Mary University of London | Sep 2021 - Ago 2023",
        details:
          "Enseñanza y tutoría en Matemáticas, Física, Electrónica y programación en Python para estudiantes de pregrado.",
      },
      experience3: {
        heading: "Ingeniero de I+D",
        placeAndDate: "Tecnológico de Monterrey | Ago 2017 - Ene 2018",
        details:
          "Desarrollo de un sistema de seguimiento ocular utilizando C# y VS Code.",
      },
    },
    skills: {
      title: "Habilidades",
      ...
      nameSection4:
        "Desarrollo de aplicaciones y web (Frameworks y otras herramientas)",
    },
    projects: {
      title: "Projectos",
      project1: {
        ...
        details:
          "Modelos de Deep Learning para la reconstrucción de objetos detrás de medios difusivos (tesis doctoral)",
        description:
          "Los medios turbios (o dispersivos) se refieren a materiales que no permiten el paso de la luz, " +
      ...
      project2: {
        ...
        details:
          "Sitio web personal creado con Svelte en VS Code, desplegado mediante GitHub y alojado en Netlify",
        description:
          "Este portafolio y mi sitio freelance, <a href='https://cesaraha.fr'>cesaraha.fr</a>, son dos " +
          "proyectos conectados pero distintos.<br/><br/>cesaraha.fr es la forma más sencilla de contactarme " +
          "para colaboraciones freelance. Fue desarrollado con <strong>React</strong>, uno de los frameworks " +
          "de JavaScript más utilizados, aprovechando la reutilización de sus componentes y su configuración " +
          "sencilla. El sitio se despliega de forma continua en <strong>Netlify</strong>, actualizándose " +
          "automáticamente después de cada push <strong>Git</strong>.<br/><br/>Este portafolio fue desarrollado " +
          "con <strong>React</strong>. Decidí separar el portafolio del sitio freelance para presentar mis " +
          "proyectos de forma clara, manteniendo el contenido profesional en una página aparte.<br/><br/>Este " +
          "portafolio está alojado en <strong>GitHub Pages</strong>, con <strong>GitHub Actions</strong> " +
      ...
      project3: {
        ...
        details:
          "Plataforma para practicar operaciones matemáticas con seguimiento del rendimiento y ejercicios adaptativos",
        description:
          "Este proyecto es un <strong>generador de operaciones matemáticas</strong>. En un primer momento, " +
      ...
      project4: {
        ...
        details:
          "Algoritmos de reconocimiento óptico de caracteres para imágenes y documentos escaneados",
        description:
          "Desarrollo de algoritmos para el reconocimiento de texto en documentos escaneados y archivos de imagen para la localización y clasificación.",
      },
      project5: {
        heading: "Segmentación celular en imágenes de microscopio",
        details:
          "Algoritmos de procesamiento de imágenes para la segmentación celular en imágenes de microscopía",
        description:
          "Desarrollo de algoritmos de procesamiento de imágenes para la segmentación de células en imágenes de microscopio para el conteo y clasificación.",
      },
      project6: {
        heading: "Detección y seguimiento de objetos con OpenCV",
        details:
          "Detección y seguimiento de objetos en archivos de video utilizando OpenCV y Python",
        description:
          "Desarrollo de aplicaciones para la detección y el seguimiento de objetos con OpenCV y Python. Entrenamiento con modelos YOLOv5 y YOLOv8.",
      },
      project7: {
        heading: "Segmentación de imágenes médicas",
        details: "Visualización, exploración y segmentación de cortes de RM",
        description:
          "Desarrollo de aplicaciones para la visualización, exploración y segmentación de cortes de IRM en cuatro modalidades diferentes.",
      },
    },
    readMore: "Ver más",
    ...
    contact: {
      title: "Contáctame!",
      description:
        "¡Me encantaría leerte! Ya sea que tengas una pregunta, quieras hablar sobre un proyecto o simplemente saludar, no dudes en ponerte en contacto conmigo.",
      tags: {
      ...
      placeholder: {
        ...
        specify:
          "Por favor proporciona una descripción general de tu solicitud",
        message:
          "Por favor proporciona una descripción detallada de tu solicitud",
      },
      errors: {
      ...
      submit: {
        ...
        error:
          "Lo siento, ha habido un error al enviar tu mensaje. Por favor intenta de nuevo.",
      },
    },
  },
};
